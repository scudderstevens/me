        ...
        <article id="top" className="main me">
          ...
          <div id="intro" className="intro-duo">
            ...
            <div className="intro-duo__copy">
              ...
              <p><strong>My Goals</strong>: Focus on solving users’ problems. Drive product adoption and engagement. Create viral growth for our suite of digital products. Create a unified product strategy. Embrace the teams' creative vision and foster a collaborative enviornment.</p>
